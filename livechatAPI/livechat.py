...
def fetch_chat_msgs():
    while True:
        YTLIVE.get_live_chat_messages(live_chat_id)
        time.sleep(30)  # Fetch messages every 5 seconds
...
#         # redirect_response += "&grant_type=authorization_code&redirect_uri=https://localhost:8080"
